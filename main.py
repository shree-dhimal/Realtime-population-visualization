...
root = tk.Tk()
root.title("Real-Time Population Visulization")
...
def get_country_population(country_code, year):
    ...
    if response.status_code == 200:
        ...
        # Extract the population value
            ...
            tk.messagebox.showinfo("ERROR",  "The Country Code you provided doesnt have the data or you have enterred wrong Country code, please try again")
            return None
...
# Create a label for country name
...
# Create a textbox for country name
